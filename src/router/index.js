...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: '/groomer-recommend',
      name: 'groomer-recommend',
      // route level code-splitting
      // this generates a separate chunk (GroomerRecommend.[hash].js) for this route
      // which is lazy-loaded when the route is visited.
      component: () => import('../views/GroomerRecommendView.vue')
    },
